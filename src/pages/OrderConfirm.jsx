...
const OrderConfirm = () => {
    ...
    return (
        <div className="mx-10">
            ...
            <h1 className="tracking-wider font-bold  uppercase text-2xl text-center">Confirmando Orden</h1>
            <span className=" text-2xl">Seleccione forma de entrega</span>
            </div>

            <div className="flex justify-center gap-16 my-8 text-white">
                <button
