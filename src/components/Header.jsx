  ...
  return (
    <div>
      <div className="bg-gradient-to-r from-zinc-800 via-zinc-900 to-zinc-950  flex md:flex-row flex-col gap-1 py-16 justify-center ">
        ...
        <div className="text-white font-bold uppercase md:text-4xl text-3xl flex flex-col items-center justify-center md:mt-0 mt-10">
          <div className="flex flex-col gap-4 items-center justify-center">
          <span className="md:text-5xl text-center text-yellow-500 font-serif">Catálogo de Hamburguesas</span>

          <h1 className="tracking-wider md:text-3xl text-2xl">Revel Burger</h1>
      ...
      <img src={imgLogo} alt="logo" className="absolute z-20 rounded-full md:size-40 size-28 md:right-20 right-10 md:bottom-5 -bottom-[11%] shadow-2xl" />

      <div>
        <h1 className="md:text-4xl text-3xl uppercase font-bold tracking-wider ml-10 my-8">
          Revel Burger
        </h1>
